        ...
        >
          ...
          {step === 7 && (
            <section>
              ...
              <div className={labelDivStyle}>
                <label htmlFor="">
                  30. Award Details Please use the following format (Name of the
                  Award, Conferring Authority, Year)
                </label>
                <input
              ...
              <div className={labelDivStyle}>
                <label htmlFor="">
                  31. Number of Papers published after completing your UG Degree
                  *
                </label>
                <input
              ...
              <div className={labelDivStyle}>
                <label htmlFor="">
                  32. Publication Details Please use the following format (Title
                  of the Paper, Journal Name, Year of publication)
                </label>
                <input
          ...
          {step === 9 && (
            <section>
              <p>
                41. Would it be fine if we solicit feedback about you from your
                Higher Official? (Mark only one oval) *
              </p>
              <div className="mb-5">
                <div className="flex mt-3 gap-3 items-center">
                  <button
            ...
            <section>
              ...
              <div className={labelDivStyle}>
                <label htmlFor="">
                  ...
                  can see in our program in light of your subsequent experience
                </label>
                <input
