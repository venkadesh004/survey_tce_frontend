...
const RecruitersFeedback = () => {
  ...
  return (
    <div className="w-3/4 flex flex-col justify-center  mx-auto h-100v font-nunito " ref={invalidElementRef}>
      <div className="h-70v">
        ...
        <div className="px-3 shadow-2xl rounded-xl " >
          {step >= 1 && step <= 5 && (
            <section>
              <p className="text-2xl font-semibold mb-3">Step {step} of 5</p>
            </section>
          )}
          <form 
            ...
            {step === 2 && (
              <section>
                <div className="flex flex-col gap-4 ">
                  ...
                  <div>
                    <p className="font-bold">
                      c{")"} Critical Thinking/Analytical Skill (Mark only one)
                      *
                    </p>
                    <div className="sm:flex items-center sm:gap-9 mt-4 grid grid-cols-2 gap-3">
                      <label htmlFor="excellent">
            ...
            {step === 3 && (
              <section>
                <div className="flex flex-col ">
                  <div className="mb-5">
                    <p className="font-bold">
                      f{")"} Leadership Skills (Mark only one) *
                    </p>
                    <div className="sm:flex items-center sm:gap-9 mt-4 grid grid-cols-2 gap-3">
                      <label htmlFor="excellent">
                        <input
              ...
              <section>
                <div>
                  <div className="flex flex-col gap-4">
                    ...
                    <div>
                      <p className="font-bold">
                        l{")"} Life Skills (Time management and Prioritization)
                        (Mark only one) *
                      </p>
                      <div className="sm:flex items-center sm:gap-9 mt-4 grid grid-cols-2 gap-3">
                        <label htmlFor="excellent">
                    ...
                    <div>
                      <p className="font-bold">
                        n{")"}Knowledge of sustainable product development (Mark
                        only one) *
                      </p>
                      <div className="sm:flex items-center sm:gap-9 mt-4 grid grid-cols-2 gap-3">
                        <label htmlFor="excellent">
            ...
            {step === 5 && (
              <section>
                <div>
                  ...
                  <p className="font-bold mb-4 mt-4">Any further Suggestions</p>
                  <textarea
