...
const GraduateExitSurvey = () => {
  ...
  return (
    <div className="w-3/4 flex flex-col justify-center  mx-auto h-100v  " ref={invalidElementRef}>
      <div className="h-70v">
              ...
              <section>
                <div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 items-center mb-3 pb-2">
                      <p className=" ">3. Ability to demonstrate Leadership</p>
                      <div className="grid grid-cols-6 items-center mb-3 pb-2 ">
                        <input
                          type="radio"
                          value="5"
                    ...
                    <div className="grid grid-cols-2 items-center mb-3 pb-2">
                      <p className=" ">7. Training in Written Communication</p>
                      <div className="grid grid-cols-6 items-center mb-3 pb-2 ">
                        <input
                          type="radio"
                          value="5"
                    ...
                    <div className="grid grid-cols-2 items-center mb-3 pb-2">
                      <p className=" ">
                        13. Your ability to make use of the above knowledge and
                        skills in final year projects/SIG Projects
                      </p>
                      <div className="grid grid-cols-6 items-center mb-3 pb-2 ">
                        <input
                          type="radio"
                ...
                <div>
                  <div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 items-center mb-3 pb-2">
                        <p className=" ">
                          9. Your ability in planning & executing the final year
                          project / SIG project
                        </p>
                        <div className="grid grid-cols-6 items-center mb-3 pb-2 ">
                          <input
                            type="radio"
                            value="5"
                            {...register("abilityInExecutingFinalYearProject", {
                              required: {
                                value: true,
                                message: "This is required",
                              },
            ...
            {step === 6 && (
              <section>
                <div>
                  ...
                  <div>
                    <div className={labelDivStyle}>
                      <label htmlFor="">Name of the College / University</label>
                      <input
              ...
              <section>
                <div>
                  ...
                  <div className="mt-4">
                    <div className={labelDivStyle}>
                      <label htmlFor="">
                        Please comment on any particular strengths or weaknesses
                        you can see in our program in light of your subsequent
                        experience
                      </label>
                      <input
                        {...register("comment", {
